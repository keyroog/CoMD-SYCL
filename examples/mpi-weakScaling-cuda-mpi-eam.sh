...
mpirun -np 1  ../bin/CoMD-cuda-mpi-eam -e -i 1 -j 1 -k 1 -x 20 -y 20 -z 20
mpirun -np 2  ../bin/CoMD-cuda-mpi-eam -e -i 2 -j 1 -k 1 -x 40 -y 20 -z 20
...
mpirun -np 16 ../bin/CoMD-cuda-mpi-eam -e -i 4 -j 2 -k 2 -x 80 -y 40 -z 40
