...
HaloExchange* initAtomHaloExchange(Domain* domain, LinkCell* boxes)
{
   ...
   // pin memory
   /*
   DPCT1026:102: The call to cudaHostRegister was removed because SYCL currently
   ...
   */
   /*
   DPCT1026:103: The call to cudaHostRegister was removed because SYCL currently
   does not support registering of existing host memory for use by device. Use
   USM to allocate memory for use by host and device.
   */
   /*
   DPCT1026:104: The call to cudaHostRegister was removed because SYCL currently
   does not support registering of existing host memory for use by device. Use
   USM to allocate memory for use by host and device.
   */
   /*
   DPCT1026:105: The call to cudaHostRegister was removed because SYCL currently
   does not support registering of existing host memory for use by device. Use
   USM to allocate memory for use by host and device.
   */
...
HaloExchange* initForceHaloExchange(Domain* domain, LinkCell* boxes, int useGPU)
{
   ...
   // pin memory
   /*
   DPCT1026:106: The call to cudaHostRegister was removed because SYCL currently
   does not support registering of existing host memory for use by device. Use
   USM to allocate memory for use by host and device.
   */
   /*
   DPCT1026:107: The call to cudaHostRegister was removed because SYCL currently
   does not support registering of existing host memory for use by device. Use
   USM to allocate memory for use by host and device.
   */
   /*
   DPCT1026:108: The call to cudaHostRegister was removed because SYCL currently
   does not support registering of existing host memory for use by device. Use
   USM to allocate memory for use by host and device.
   */
   /*
   DPCT1026:109: The call to cudaHostRegister was removed because SYCL currently
   does not support registering of existing host memory for use by device. Use
   USM to allocate memory for use by host and device.
   */
